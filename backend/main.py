    ...
    def do_short():
        try:
            ...
            result = upload_video(
                ...
                title=title,
                description=f"{video.get('description','')}",
...
# def run_short_pipeline(prompt: str, ambience: str = "stars"):
#     """Full pipeline for generating a YouTube Short from scratch."""
#     import uuid
#     video_id = str(uuid.uuid4())
#     try:
#         from pipeline.script_pipeline import generate_script_video
#         generate_script_video(prompt=prompt, video_id=video_id, is_short=True, ambience=ambience)
#     except Exception as e:
#         print(f"❌ Short pipeline failed: {e}")
