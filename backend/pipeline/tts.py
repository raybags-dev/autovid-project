...
def synthesize(text: str, video_id: str) -> dict:
    ...
    # Try primary ElevenLabs voice
    success = _synthesize_elevenlabs(clean_text, mp3_path)
...
# def _synthesize_elevenlabs(text: str, mp3_path: Path) -> bool:
#     """
#     Try ElevenLabs synthesis. Returns True on success, False on quota/auth error.
